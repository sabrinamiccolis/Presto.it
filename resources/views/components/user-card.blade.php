<div class="w-full md:w-1/4 mx-auto relative">
    <div class="shadow-xl shadow-[#1f2426] rounded-xl bg-black text-white p-4 relative">
        ...
        <div class="p-3">
            ...
            <a href="{{ route('announcements.edit', $announcementId) }}" class="btn w-full text-center my-2">{{ __('ui.edit')}}</a>
        ...
        @if ($announcement['revised']!=true)
            <div class="absolute left-0 right-0 top-0 text-center z-30">  
                <span class=" bg-warning rounded-full text-center text-black uppercase font-bold p-2">In revisione</span>   
            </div> 
        @endif
    </div>
</div>